<template>
    ...
    <div class="flex justify-center">
        <div class="w-full max-w-screen-xl mx-auto p-4">
            <h1 class="text-2xl font-bold mb-2 mt-4 px-8">Oblečenie</h1>
            <div class="flex flex-wrap justify-between">
                <div v-for="(item, index) in cartStore.products" :key="index"
                    ...
                    <div class="flex items-start">
                        <button
                            class="px-4 py-1 bg-transparent text-bg_stats border border-bg_stats rounded hover:bg-blue-700 mt-2 expandable-button"
...
export default {
    ...
    created() {
        this.cartStore.loadProducts('clothes');     //hook životneho cyklu, volá sa pri vytvorení komponentu, tu sa načitavaju produkty do cartStoru
    }
}
</script>
